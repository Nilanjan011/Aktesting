<div class="modal fade" id="bookAppoint" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <form method="POST" action="{{ route('BookAppoint') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <button id="singlebutton" style="background: #12557f;" class="new-btn-d br-2">Make An Appointment</button>
                        </div>
                    </div>
                </form>
            </div>
