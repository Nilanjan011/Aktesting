...
<div class="table-responsive">
    <table id="example" class="table table-bordered" style="width:100%">
        ...
        <tbody>
        @foreach($appointApproves as $appointPanddind)
                <tr>
                    ...
                    <td>{{$appointPanddind->Test}}</td>
                    <td>{{$appointPanddind->Preferred_date}}</td>
                    <td>{{$appointPanddind->Preferred_tine}}</td>
                    <td>{{$appointPanddind->Address}}</td>
                    <td>{{$appointPanddind->Pincode}}</td>
